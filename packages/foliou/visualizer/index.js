...
(function() {
	...
	if (typeof exports === "object") {
		// CommonJS
		module.exports = Factory(require("../device"), require("../utli"));
	} else if (typeof define === "function" && define.amd) {
		// AMD
		define(["../device", "foliou/utli"], Factory);
	} else {
		// Global Variables
		if (!window.Foliou) {
			window.Foliou = {};
		}
		window.Foliou.Visualizer = Factory(window.Foliou.Device, window.Foliou.ztUtli);
	}
})();
