...
function() {
    ...
    function(e, t) {
        ...
        function d(e, t, i) {
            if(!!require){
                require([e],function(obj){
                    "function" == typeof t && t(obj)
                });
                return;
            }
        ...
        w = function(e) {
            ...
            t.prototype.__hlsOnError = function(e, t) {
                ...
                case Hls.ErrorTypes.NETWORK_ERROR:
                    o.indexOf("TimeOut") > 0 ? f.console.error("鍔犺浇瑙嗛鏂囦欢瓒呮椂") : f.console.error("鏃犳硶鍔犺浇瑙嗛鏂囦欢锛岃妫€鏌ョ綉缁滐紝浠ュ強瑙嗛鏂囦欢鏄惁鍏佽璺ㄥ煙璇锋眰璁块棶锛宮3u8鏂囦欢鏄惁瀛樺湪 " + (t.response && t.response.status ? "netstatus:" + t.response.status: "")),
                    this.notify({
                        type: "error",
                        code: 2,
                        timeStamp: +new Date
