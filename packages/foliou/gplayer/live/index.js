...
function() {
    ...
    function(e, t, i) {
        ...
        t.GiantCdn = 'https://cdnsapi.ztgame.com/site/js/gplayer/live/'
        t.VideoType = {
            RTMP: "rtmp",
            FLV: "flv",
            M3U8: "m3u8"
        ...
        w = function(e) {
            ...
            t.prototype.load = function(e, t) {
                ...
                this.el.src = e;
                    ...
                    }) : this.__hlsLoaded(e)) : o && (this.__type = f.VideoType.FLV, "undefined" == typeof window.flvjs ? h.loadScript(f.GiantCdn + "libs/flv.min.js",
                    function(obj) {
                        window.flvjs = obj;
